...
const copyByLocale = {
  pt: {
    ...
    subtitle:
      "Valida o código do convite e define a tua palavra-passe para ativar o acesso na app APEX COACH.",
    email: "Email",
    ...
    missingEnv: "Variáveis do Supabase em falta no projeto web.",
    confirmEmail:
      "Conta criada. Confirma o email e depois faz login na app para concluir a ativação.",
    fallbackError: "Não foi possível concluir o registo.",
    doneApex:
